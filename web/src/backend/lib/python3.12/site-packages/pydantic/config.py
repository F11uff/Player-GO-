...
class ConfigDict(TypedDict, total=False):
    ...
    * `ignore` - Ignore any extra attributes.
    ...
    user = UserRegistration(name='John Doe', age=20)  # (2)!
    print(user)
    #> name='John Doe'
    ```
    ...
    user = UserRegistration(name='John Doe', age=20)  # (1)!
    print(user)
    ...
    try:
        UserRegistration(name='John Doe', age=20)
    ...
    user = UserRegistration(full_name='John Doe', age=20)  # (2)!
    print(user)
    #> name='John Doe' age=20
    user = UserRegistration(name='John Doe', age=20)  # (3)!
    print(user)
    #> name='John Doe' age=20
    ```
    ...
    user = UserRegistration(name='John Doe')  # (1)!
    print(user)
    #> name='John Doe'
    user.name = 123  # (1)!
    print(user)
    ...
    class UserRegistration(BaseModel, validate_assignment=True):  # (1)!
        name: str

    user = UserRegistration(name='John Doe')  # (2)!
    print(user)
    #> name='John Doe'
    try:
        user.name = 123  # (3)!
    ...
    class UserRegistration(BaseModel, revalidate_instances='never'):  # (1)!
        hobbies: List[str]

    class SubUser(UserRegistration):
        sins: List[str]

    class Transaction(BaseModel):
        user: UserRegistration

    my_user = UserRegistration(hobbies=['reading'])
    t = Transaction(user=my_user)
    print(t)
    #> user=UserRegistration(hobbies=['reading'])

    my_user.hobbies = [1]  # (2)!
    t = Transaction(user=my_user)  # (3)!
    print(t)
    #> user=UserRegistration(hobbies=[1])
    ...
    class UserRegistration(BaseModel, revalidate_instances='always'):  # (1)!
        hobbies: List[str]
    ...
    t = Transaction(user=my_sub_user)
    print(t)  # (3)!
    #> user=UserRegistration(hobbies=['scuba diving'])
    ```
    ...
    class UserRegistration(BaseModel, revalidate_instances='subclass-instances'):  # (1)!
        hobbies: List[str]
    ...
    2. This is not revalidated, since `my_user` is not a subclass of `UserRegistration`.
    3. Using `'never'` we would have gotten `user=SubUser(hobbies=['scuba diving'], sins=['lying'])`.
    """
