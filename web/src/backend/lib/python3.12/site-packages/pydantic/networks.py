...
* UserRegistration info required
* TLD not required
* Host required
...
* UserRegistration info not required
* Database name not required
* Port not required
* UserRegistration info may be passed without user part (e.g., `mongodb://mongodb0.example.com:27017`).
"""
...
class NameEmail(_repr.Representation):
    ...
    user = UserRegistration(email='Fred Bloggs <fred.bloggs@example.com>')
    print(user.email)
    #> Fred Bloggs <fred.bloggs@example.com>
    print(user.email.name)
    #> Fred Bloggs

    user = UserRegistration(email='fred.bloggs@example.com')
    print(user.email)
    #> fred.bloggs <fred.bloggs@example.com>
    print(user.email.name)
    #> fred.bloggs
